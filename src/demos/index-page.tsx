...
const ALL_DEMOS: DemoCard[] = [
  ...
  // Prototypes
  {
    title: 'Hiring End-to-End Flow',
    description:
      'Full 14-screen hiring wizard for EOR (India): hiring method → work location → employment details → compensation → agreements → review → employee profile.',
    path: '/hiring-end-to-end',
    icon: Icon.TYPES.PEOPLE_HEART_OUTLINE,
    category: 'prototype',
  },
  {
    title: 'HRIS AI — Hire Employee',
    description:
      'AI-assisted hire employee entry screen from HRIS-AI Patterns: composer input, prompt chips, and manual hire details form.',
    path: '/hire-employee-ai',
    icon: Icon.TYPES.RIPPLING_AI,
    category: 'prototype',
  },
  {
    title: 'Job Templates × Business Structures',
    description:
      'Hybrid approach for enforcing job codes in Job Templates — select business structure paths to auto-apply job codes, or manually configure dimensions.',
